...
Read more: [Defense Against Counterfeiting in Shielded Pools](https://zips.z.cash/protocol/protocol.pdf) — the original ECC blog post is no longer available, so this links to the corresponding section of the Zcash protocol specification
